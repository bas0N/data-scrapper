...
const fetchDataFromTable = async () => {
 ...
 // Define column names
 const columnNames = ['Nazwa', 'Ticker', 'Kurs', 'Zmiana', 'Zmiana Procentowa', 'Wpływ na indeks', 'Udział w obrocie', 'Pakiet', 'Udział w portfelu'];

 // Extract data from the specified table
 const tableData = await page.evaluate((columns) => {
   const data = [];
   const tableRows = document.querySelectorAll('.box945 table tbody tr'); // Target the specific table with the class "box945"
